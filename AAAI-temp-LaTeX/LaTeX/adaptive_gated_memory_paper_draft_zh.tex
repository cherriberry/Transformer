...
表~\ref{tab:six-dense-comparison} 汇总统一 TinyStories 协议下的 Dense FFN 结果。训练
...
\centering
\scriptsize
\caption{六种基础架构的 Dense FFN 结果。时间为十百万预测词元的近似墙钟时间；Keyformer 不属于训练型架构，故单列于后文。}
...
\centering
\scriptsize
\caption{六种骨干在全层 MoE 下的 seed-17 结果。Keyformer 使用 Full-Attention+MoE 检查点，但本身不参与训练。}
...
\centering
\scriptsize
\caption{本文事实记忆与六种基础路径的机制级对照。六种基础架构的长期事实指标在当前 TinyStories 语言建模协议中未测量，故不以 N/A 伪装成零。}
...
\midrule
Dense & SWA-only & 5.21\% & 1.38947 & N/A & N/A & 0.00 & N/A & -- \\
Dense & Fixed-LRU & 74.65\% & 0.50323 & 92.01\% & 90.28\% & 4.25 & 75.00\% & -- \\
...
MoE & SWA-only & 5.21\% & 1.38736 & N/A & N/A & 0.00 & N/A & -- \\
MoE & Fixed-LRU & 65.28\% & 0.57731 & 93.06\% & 93.06\% & 4.25 & 75.00\% & -- \\
